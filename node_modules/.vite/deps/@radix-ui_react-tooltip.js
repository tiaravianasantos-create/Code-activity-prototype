...
var TooltipProvider = __name7((props) => {
  const {
    __scopeTooltip,
...
var Tooltip = __name7((props) => {
  ...
  const [contentIdState, setContentId] = React8.useState(void 0);
...
var TooltipTrigger = React8.forwardRef(
  __name7(function TooltipTrigger2(props, forwardedRef) {
...
var TooltipPortal = __name7((props) => {
...
var TooltipContent = React8.forwardRef(
  __name7(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React8.forwardRef(__name7(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  ...
  React8.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name7((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name7((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React8.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name7((event) => {
        const target = event.target;
...
var TooltipContentImpl = React8.forwardRef(
  // blank line to reduce diff noise
  __name7(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
    ...
    React8.useEffect(() => {
      if (context.trigger) {
        const handleScroll = __name7((event) => {
...
var TooltipArrow = React8.forwardRef(
  __name7(function TooltipArrow2(props, forwardedRef) {
...
__name7(getExitSideFromRect, "getExitSideFromRect");
...
__name7(getPaddedExitPoints, "getPaddedExitPoints");
...
__name7(getPointsFromRect, "getPointsFromRect");
...
__name7(getHullPresorted, "getHullPresorted");
